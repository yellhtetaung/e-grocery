<template>
  <v-row justify="center" class="space px-16">
    <v-col
      ...
      :key="i"
    >
      <v-card class="mx-auto rounded-xl pa-5" max-width="300" flat outlined>
        ...
        <v-card-title class="grey--text grey-darken-1 caption mt-n6">{{
          product.subtitle
        }}</v-card-title>
        ...
        <v-card-actions class="mw-2 mt-n4">
          ...
          <strong class="mx-2" v-text="bmp"></strong>
          <v-btn outlined class="mt-n2 add">
